...
describe("MofTest", () => {
  ...
  beforeEach(() => {
    ...
    mofSingleMock = new Mof.Builder().add(mock1, when1, verify1).build();
    mofTwoMocks = new Mof.Builder()
      .add(mock1, when1, verify1)
      .add(mock2, when2, verify2)
      .build();
    mofThreeMocks = new Mof.Builder()
      .add(mock1, when1, verify1)
      .add(mock2, when2, verify2)
      .add(mock3, when3, verify3)
      .build();

    mofTwoMocksInASimpleClosedCurve = new Mof.Builder()
      .add(mock1, when1, verify1)
      .add(mock1, when2, verify2)
      .build();
    mofThreeMocksInASimpleClosedCurve = new Mof.Builder()
      .add(mock1, when1, verify1)
      .add(mock2, when2, verify2)
      .add(mock1, when3, verify3)
      .build();
    ...
    mofTwoMocksInASimpleClosedCurveWithVerifyNoInteractions = new Mof.Builder()
      ...
      .enableVerifyNoInteractions(verifyNoInteractionLambda)
      .build();
    mofThreeMocksInASimpleClosedCurveWithVerifyNoInteractions =
      new Mof.Builder()
        .add(mock1, when1, verify1)
        .add(mock2, when2, verify2)
        .add(mock1, when3, verify3)
  ...
  describe("Builder", () => {
    ...
    test("staticMethod_success", () => {
      Mof.builder().add(mock1, when1, verify1).build();
    });

    test("constructor_success", () => {
      new Mof.Builder().add(mock1, when1, verify1).build();
    });
    ...
    test("whenMocksIsNull_ThenThrowError", () => {
      ...
      expect(() => {
        new Mof.Builder().add(null, when1, verify1).build();
    ...
    test("whenMocksInANonSimpleCurve_ThenThrowError", () => {
      const expectedMessage =
        "m3 cannot be the same as a previous mock in mocks!";

      expect(() => {
        new Mof.Builder()
          .add(mock1, when1, verify1)
          .add(mock2, when2, verify2)
          .add(mock2, when3, verify3)
          .build();
      }).toThrow(expectedMessage);
    });
  });
  ...
  describe("When", () => {
    describe("All", () => {
      ...
      test("calledWithMockThatThrowsError_ThenThrowError", () => {
        const expectedMessage =
          "w1 throws an error! Please check your whens. Error Message: Sample Error Message";
  ...
  describe("WhenAfter", () => {
    describe("First", () => {
      ...
      test("calledWithWhenThatThrowError_ThenThrowError", () => {
        const expectedMessage =
          "w2 throws an error! Please check your whens. Error Message: Sample Error Message";
  ...
  describe("Verify", () => {
    describe("All", () => {
      ...
      test("calledWithMockThatThrowsError_ThenThrowError", () => {
        const expectedMessage =
          "v1 throws an error! Please check your verifies. Error Message: Sample Error Message";
  ...
  describe("VerifyAfter", () => {
    describe("First", () => {
      ...
      test("calledWithMockThatThrowsError_ThenThrowError", () => {
        const expectedMessage =
          "v2 throws an error! Please check your verifies. Error Message: Sample Error Message";
  ...
  describe("VerifyNoInteractions", () => {
    describe("All", () => {
      ...
      test("twoMocksAreInASimpleClosedCurve_success", () => {
        mofTwoMocksInASimpleClosedCurveWithVerifyNoInteractions.verifyNoInteractions(
          ALL
        );
      ...
      test("threeMocksAreInASimpleClosedCurve_success", () => {
        mofThreeMocksInASimpleClosedCurveWithVerifyNoInteractions.verifyNoInteractions(
          ALL
        );
      ...
      test("calledWithMockThatThrowsError_ThenThrowError", () => {
        const expectedMessage =
          "verifyNoInteractionLambda called with m1 throws an error! Please check your verifyNoInteractionLambda and mocks. Error Message: Sample Error Message";
    ...
    describe("Remaining", () => {
      describe("VerifyAll", () => {
        ...
        test("twoMocksAreInASimpleClosedCurve_success", () => {
          ...
          mofTwoMocksInASimpleClosedCurveWithVerifyNoInteractions.verify(
            REMAINING
          );
        ...
        test("threeMocksAreInASimpleClosedCurve_success", () => {
          ...
          mofThreeMocksInASimpleClosedCurveWithVerifyNoInteractions.verify(
            REMAINING
          );
      ...
      describe("RemainingNested", () => {
        describe("VerifyAll", () => {
          test("success", () => {
            ...
            mofSingleMockWithVerifyNoInteractions.verifyNoInteractions(
              REMAINING
            );
          ...
          test("threeMocks_success", () => {
            ...
            mofThreeMocksWithVerifyNoInteractions.verifyNoInteractions(
              REMAINING
            );
        ...
        describe("VerifyThrough", () => {
          describe("First", () => {
            ...
            test("twoMocks_success", () => {
              ...
              mofTwoMocksWithVerifyNoInteractions.verify(REMAINING);
              mofTwoMocksWithVerifyNoInteractions.verifyNoInteractions(
                REMAINING
              );
            ...
            test("twoMocksAreInASimpleClosedCurve_success", () => {
              mofTwoMocksInASimpleClosedCurveWithVerifyNoInteractions.verifyThrough(
                FIRST
              );
              mofTwoMocksInASimpleClosedCurveWithVerifyNoInteractions.verify(
                REMAINING
            ...
            test("threeMocksAreInASimpleClosedCurve_success", () => {
              mofThreeMocksInASimpleClosedCurveWithVerifyNoInteractions.verifyThrough(
                FIRST
              );
              mofThreeMocksInASimpleClosedCurveWithVerifyNoInteractions.verify(
                REMAINING
        ...
        describe("VerifyBefore", () => {
          describe("First", () => {
            ...
            test("twoMocksAreInASimpleClosedCurve_success", () => {
              mofTwoMocksInASimpleClosedCurveWithVerifyNoInteractions.verifyBefore(
                FIRST
              );
              mofTwoMocksInASimpleClosedCurveWithVerifyNoInteractions.verify(
                REMAINING
            ...
            test("threeMocksAreInASimpleClosedCurve_success", () => {
              mofThreeMocksInASimpleClosedCurveWithVerifyNoInteractions.verifyBefore(
                FIRST
              );
              mofThreeMocksInASimpleClosedCurveWithVerifyNoInteractions.verify(
                REMAINING
        ...
        describe("VerifyAfter", () => {
          describe("First", () => {
            ...
            test("twoMocksAreInASimpleClosedCurve_success", () => {
              mofTwoMocksInASimpleClosedCurveWithVerifyNoInteractions.verifyAfter(
                FIRST
              );
              mofTwoMocksInASimpleClosedCurveWithVerifyNoInteractions.verify(
                REMAINING
            ...
            test("threeMocksAreInASimpleClosedCurve_success", () => {
              mofThreeMocksInASimpleClosedCurveWithVerifyNoInteractions.verifyAfter(
                FIRST
              );
              mofThreeMocksInASimpleClosedCurveWithVerifyNoInteractions.verify(
                REMAINING
  ...
  describe("VerifyNoInteractionsAfter", () => {
    describe("First", () => {
      ...
      test("twoMocksAreInASimpleClosedCurve_success", () => {
        mofTwoMocksInASimpleClosedCurveWithVerifyNoInteractions.verifyNoInteractionsAfter(
          FIRST
        );
      ...
      test("threeMocksAreInASimpleClosedCurve_success", () => {
        mofThreeMocksInASimpleClosedCurveWithVerifyNoInteractions.verifyNoInteractionsAfter(
          FIRST
        );
